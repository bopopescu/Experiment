...
public class ProtoFrontend implements FrontendService.Iface {
   ...
   */
  public static final double DEFAULT_WARMUP_JOB_ARRIVAL_RATE_S = 0;//10;

  /**
   * Duration of warmup period.
   */
  public static final int DEFAULT_WARMUP_S = 0;//10;

  /**
   * Amount of time to wait for queues to drain once warmup period is over.
   */
  public static final int DEFAULT_POST_WARMUP_S = 0;// 60;

  /**
   * Amount of time to launch tasks for (not including the warmup period).
   */
  public static final int DEFAULT_EXPERIMENT_S = 1;//300;

  public static final double DEFAULT_JOB_ARRIVAL_RATE_S = 1;//10; // Jobs/second
  public static final int DEFAULT_TASKS_PER_JOB = 10;          // Tasks/job
  ...
  private void launchTasks(List<UserInfo> users, double lambda, int launch_duration_s,
    ...
    while (System.currentTimeMillis() < end) {
      ...
      LOG.debug("Loop iteration is this " + loopIter);
      loopIter++;
      ...
      //This is the time when I have gotten the actual job

      long currentTime = System.currentTimeMillis();
      LOG.debug("Job recieved at this time " + currentTime);
  ...
  public static void main(String[] args) {
    ...
    System.out.println("The arguments for the proto frontend are this : " + args);
    LOG.debug("The arguments for the proto frontend are this : " + args);
