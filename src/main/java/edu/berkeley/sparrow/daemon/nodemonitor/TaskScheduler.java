...
public abstract class TaskScheduler {
  protected class TaskSpec {
    ...
    public TaskSpec(TEnqueueTaskReservationsRequest request, InetSocketAddress appBackendAddress) {
      ...
      System.out.println("Appid is this " + request.getAppId() + " User is this " + user + " Request id is this " + requestId + "Scheduler host is this " + request.getSchedulerAddress().getHost() + "Port is this " + request.getSchedulerAddress().getPort()  + " BackEnd Address is ths " + appBackendAddress);
